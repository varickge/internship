    ...
    def _delete(self,current,salary,previous,is_left):
        if current:
            if current.value["salary"]==salary:
                ...
                elif current.left is None:#One child Node(Left is None)
                    if previous:
                        if is_left:
                ...
                elif current.right is None:  # One child Node(Right is None)
                    if previous:
                        if is_left:
                ...
                else:#Both left and right child nodes are not None
